...
class WanTextEncoder(torch.nn.Module):
    def __init__(self) -> None:
        ...
        # Construct on the meta device (shapes/dtypes only, no real memory or
        # random init) since load_state_dict(assign=True) below immediately
        # replaces every parameter with the checkpoint's real tensors anyway.
